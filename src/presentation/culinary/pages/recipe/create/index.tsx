...
import { useRecipeCreateForm } from '../hooks/use-recipe-create.form';
...
export function CulinaryRecipeCreatePage({
  recipeService,
  categoryService,
}: Props) {
  const {
  ...
  return (
    <Page title={t('culinary.recipe.create.title')}>
      <Card description={t('culinary.recipe.create.description')}>
