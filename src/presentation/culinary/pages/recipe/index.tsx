...
export const CulinaryRecipePage = ({
  recipeService,
  ...
  return (
    <>
      <ConfirmModal
        open={!!selectedRecipe}
        title={t('culinary.recipe.delete.title')}
        description={t('culinary.recipe.delete.description')}
      ...
      <Page title={t('culinary.recipe.title')}>
        <div className={styles.container}>
          <div className={styles.header}>
            <div>
              <p className={styles.description}>
                {t('culinary.recipe.description')}
              </p>
            </div>

            <CreateButton
              title={t('culinary.recipe.create.title')}
              visible={authorizationProvider.hasPermission(
                'culinary.recipe.create',
              )}
