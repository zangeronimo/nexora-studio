...
import { useTagCreateForm } from '../hooks/use-tag-create.form';
...
export function CulinaryTagCreatePage({ tagService }: Props) {
  const {
    errors,
    hasError,
    isPristine,
  ...
  return (
    <Page title={t('culinary.tag.create.title')}>
      <Card description={t('culinary.tag.create.description')}>
