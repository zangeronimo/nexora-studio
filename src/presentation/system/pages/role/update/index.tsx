...
import { useRoleUpdateForm } from '../hooks/use-role-update.form';

type Props = {
  roleService: IRoleService;
};

export function SystemRoleUpdatePage({ roleService }: Props) {
  const { id } = useParams();
  const {
    errors,
    hasError,
  ...
  return (
    <Page title={t('system.role.update.title')}>
      <Card description={t('system.role.update.description')}>
